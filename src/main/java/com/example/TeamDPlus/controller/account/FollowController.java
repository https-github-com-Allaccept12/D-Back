package com.example.TeamDPlus.controller.account;


import com.example.TeamDPlus.dto.Success;
import com.example.TeamDPlus.jwt.UserDetailsImpl;
import com.example.TeamDPlus.service.account.follow.FollowService;
...
public class FollowController {
    ...
    public ResponseEntity<Success> doFollow(@AuthenticationPrincipal UserDetailsImpl user,
                                            @RequestBody AccountRequestDto.AccountVisit accountId) {
    ...
    //팔로워리스트
    @GetMapping("/follower")
    public ResponseEntity<Success> followerList(@RequestBody AccountRequestDto.AccountVisit dto) {
        return new ResponseEntity<>(new Success("팔로워 리스트",
                followService.findFollowingList(dto.getAccount_id())),HttpStatus.OK);
    }
    //팔로잉리스트
    @GetMapping("/following")
    public ResponseEntity<Success> followingList(@RequestBody AccountRequestDto.AccountVisit dto) {
